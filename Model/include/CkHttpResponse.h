...
// This header is generated for Chilkat 9.5.0.92

#define _CkVersion 9.5.0.92
...
class CK_VISIBLE_PUBLIC CkHttpResponse  : public CkMultiByteBase
{
	...
	// string. For example, if a caller passes the following string in encodedParamString:
	// oauth_token=ABC&oauth_token_secret=123&oauth_callback_confirmed=true and
